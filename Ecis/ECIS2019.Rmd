...
ideas_assessment <- ideas_overall_scores%>%
  group_by(Idea_ID)%>%
  summarise_all(mean)
#  summarise(Engineering=round(mean(Engineering)),Finance=round(mean(Finance)), Construction=round(mean(Construction)), Electronics=round(mean(Electronics)))

ideas_assessment <- as.integer(ideas_assessment[,-2])
